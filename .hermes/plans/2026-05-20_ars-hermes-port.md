...
Наша стратегия (каскад fallback, академические → авторитетные):
```
1. Киберленинка — основной академический источник (парсинг, не API)
...
2. eLibrary/РИНЦ — второй академический источник
   Fallback: web_search("site:elibrary.ru KEYWORDS") + web_extract
   Возвращает: метаданные, РИНЦ-индекс

3. Google Scholar (русский сегмент) — третий
   Поиск: web_search("KEYWORDS научная статья")

4. Авторитетные неакадемические (если академических недостаточно):
   - Государственные отчёты: web_search("KEYWORDS отчёт аналитика")
   - Отраслевые СМИ: vedomosti.ru, rbc.ru, kommersant.ru
   - Энциклопедии: encyclopaedia_britannica, bigenc.ru
   - Отчёты консалтинга: mckinsey, deloitte, pwc (русские версии)
   - Википедия (только как отправная точка, не как источник)

5. Semantic Scholar — fallback для англоязычных
   API: curl api.semanticscholar.org (без ключа, 1 req/sec)

6. arXiv — для препринтов и ML/AI тематики
   Через skill arxiv (встроенный)
```

Важно: агент-библиограф должен ЯВНО указывать тип источника
(академический / отчёт / аналитика / СМИ) в аннотированной библиографии.
